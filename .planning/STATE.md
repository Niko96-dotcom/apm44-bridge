...
last_updated: 2026-07-01T11:22:41.550Z
...
**Current focus:** Phase 49 — public docs and release hygiene gate
...
- v1.1 reconciled baseline: Phase 42 covered the visible Quit UI and graceful
  app exit; Phase 43 covered public docs/repo surface; Phase 44 covered
  secret/security, CI, installed-sync, and artifact release gates; Phase 45
  covered latest GitHub release publication closure. Live GitHub state on
  2026-07-01 shows v0.11.1 as latest.

- v1.2 roadmap: Phase 46 promotes Developer ID Installer-signed PKG
  installation; Phase 47 makes the DMG a PKG-first professional wrapper; Phase
  48 proves install/upgrade/uninstall from the final artifact; Phase 49 aligns
  public docs and fail-closed release gates; Phase 50 publishes and re-verifies
...
- Phase 46 must confirm a valid Developer ID Installer identity exists before
  claiming a public PKG installer path. If missing, certificate setup is part of
  the phase or publication remains blocked.
- Phase 50 must publish only from a clean commit/tag and then verify downloaded
  GitHub assets; local build output alone is not release proof.
...
| packaging | Signed PKG installer | superseded by active v1.2 scope |

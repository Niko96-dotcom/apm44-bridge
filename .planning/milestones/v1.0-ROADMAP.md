...
- [x] **Phase 38: Input and Output Drift Ownership** - Remove input-callback (completed 2026-06-14)
  `DriftController` mutation and publish input overruns through an atomic
  counter.
- [x] **Phase 39: HAL IO Running Atomic Guard** - Make `ioRunning_` atomic and (completed 2026-06-14)
  preserve stopped-IO behavior with regression coverage.
- [x] **Phase 40: Mono-Lane Callback Serialization Proof** - Prove/document (completed 2026-06-14)
  libASPL callback serialization or redesign lane assembly to avoid unsafe
  shared mutable callback state.
- [x] **Phase 41: Regression and Release Validation Closure** - Add source-audit (completed 2026-06-14)

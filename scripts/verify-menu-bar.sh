...
xcodebuild -project App/APM44Bridge.xcodeproj -scheme APM44Bridge -destination 'platform=macOS' test -only-testing:APM44BridgeTests CODE_SIGNING_ALLOWED=NO 2>&1 | tail -20

...
P12_PASS="${APM44_INSTALLER_P12_PASS:-$(python3 -c 'import secrets; print(secrets.token_urlsafe(32))')}"
P12_NAME="${APM44_INSTALLER_P12_NAME:-Developer ID Installer}"
...
if [[ "${APM44_KEEP_INSTALLER_P12:-0}" != "1" ]]; then
  rm -f "$P12"
fi

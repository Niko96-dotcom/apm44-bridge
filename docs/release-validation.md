...
This checklist is the current 0.10.0 DMG-primary distribution validation path.
...
xcrun stapler validate "build/signing/APM44Bridge-${APM44_VERSION:-0.10.0}.dmg"
spctl --assess --type open --context context:primary-signature --verbose=4 "build/signing/APM44Bridge-${APM44_VERSION:-0.10.0}.dmg"
...
hdiutil attach "build/signing/APM44Bridge-${APM44_VERSION:-0.10.0}.dmg"
...
```bash
bash scripts/codesign-verify-release.sh
codesign --verify --verbose "build/signing/APM44Bridge-${APM44_VERSION:-0.10.0}.dmg"
xcrun stapler validate "build/Release/APM44 Bridge.app"
xcrun stapler validate build/Driver/APM44Bridge.driver
xcrun stapler validate "build/signing/APM44Bridge-${APM44_VERSION:-0.10.0}.dmg"
spctl --assess --type open --context context:primary-signature --verbose=4 "build/signing/APM44Bridge-${APM44_VERSION:-0.10.0}.dmg"

...
This checklist is the current 0.12.3 PKG-in-DMG distribution validation path.
...
xcrun stapler validate "build/signing/APM44Bridge-${APM44_VERSION:-0.12.3}.dmg"
spctl --assess --type open --context context:primary-signature --verbose=4 "build/signing/APM44Bridge-${APM44_VERSION:-0.12.3}.dmg"
...
hdiutil attach "build/signing/APM44Bridge-${APM44_VERSION:-0.12.3}.dmg"
...
```bash
bash scripts/codesign-verify-release.sh
codesign --verify --verbose "build/signing/APM44Bridge-${APM44_VERSION:-0.12.3}.dmg"
